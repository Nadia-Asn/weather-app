...
class City: Object,Codable {
    ...
    convenience init(id: Int, name: String, weather: Weather) {
        self.init()
        self.id = id
        self.name = name
    ...
    convenience required init(from decoder: Decoder) throws {
        ...
        self.init(id: id, name: name, weather: weather)
    }
...
class Weather:Object, Codable {
    ...
    convenience required init(from decoder: Decoder) throws {
       ...
       // let descript = try? values.decode(String.self, forKey: .descript)
        
        self.init(cityName: cityName, code: code, visibility: visibility, dt: dt, infoWeather: infoWeather, wind: wind, rain: rain, clouds: clouds, descriptif: descriptif!)
        
        
    }
    
    convenience init( cityName: String, code: Int,visibility: Int, dt: Int, infoWeather: InfoWeather, wind: Wind, rain: Rain?, clouds: CLouds, descriptif: [Descriptif]) {
        self.init()
